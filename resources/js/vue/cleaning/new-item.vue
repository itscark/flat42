        ...
        <form @submit.prevent="onSubmit" class="card"
            ...
            <div class="card-body">
                <div class="form-group">
                    <input class="form-control input-sm" type="text" name="body" id="body"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="period" v-model="form.period">
                        <option v-for="item in this.period"
                                :value="item.id " >{{item.name}}</option>
                    </select>
                    <div class="invalid-feedback" v-if="form.errors.has('period')" v-text="form.errors.get('period')"></div>
                </div>

                <div class="form-group">
                    <button class="btn btn-outline-dark btn-sm" type="submit" :disabled="form.errors.any()"><i
                            class="fas fa-plus"></i> Tätigkeit hinzufügen
                    </button>
                </div>
            </div>
        </form>
