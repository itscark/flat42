...
<div>
    <form action="" method="post" @submit.prevent="onSubmit"
        ...
        <div class="form-group col-md">
            ...
            <input class="form-control" type="text" name="title" id="title" v-model="form.title" value="">
        ...
        <div class="form-group col-md">
            ...
            <textarea class="form-control" name="body" v-model="form.body" id="body"
                      placeholder="Poste etwas neues"></textarea>
...
<script>
    export default {
        ...
        methods:{
            onSubmit(){
               this.form.post('../api/events/create', '../events')
