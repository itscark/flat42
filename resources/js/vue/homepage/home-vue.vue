<template>
    <div>
        <full-page ref="fullpage" :options="options" id="fullpage">
                ...
                <div class="welcome-wrapper">
                    ...
                    <div class="subheadline text-align-center">
                        <p class="subheadline-text">
                            ...
                            elitr, sed diam nonumy eirmod tempor nonumy eirmod
                            tempor nonumy eirmod tempor
                        </p>
                    </div>
            ...
            <contentSection
                :filepath="'svg/homepage/undraw_add_to_cart_vkjp.svg'"
                :title="'Shopping'"
                :content="
            ...
            <contentSection
                :filepath="'svg/homepage/undraw_content_vbqo.svg'"
                :title="'News'"
                :content="
                    'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor\n' +
                        '                                invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et\n' +
            ...
            <contentSection
                :filepath="'svg/homepage/undraw_having_fun_iais.svg'"
                :title="'Events'"
                :content="
                    'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor\n' +
                        '                                invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et\n' +
            ...
            <contentSection
                :filepath="'svg/homepage/undraw_schedule_pnbk.svg'"
                :title="'Cleaning'"
                :content="
                    'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor\n' +
                        '                                invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et\n' +
